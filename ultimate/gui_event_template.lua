...
-- Rest des bisherigen Event-GUI-Codes ...

local EventGUI = {}

--[[
EventGUI.show("Event gestartet!", "Das Event beginnt in 10 Sekunden!", function()
    outputChatBox("Eventfenster geschlossen!")
end)
]]

function EventGUI.show(title, infoText, onClose)
    UniversalGUI.create{
        title = title,
        logo = "images/event_icon.png",
        labels = {
            {text = infoText, color = {255,255,255}},
        },
        buttons = {},
        onClose = onClose
    }
