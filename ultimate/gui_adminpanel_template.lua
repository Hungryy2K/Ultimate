...
-- Rest des bisherigen Adminpanel-GUI-Codes ...

local AdminPanelGUI = {}

--[[
AdminPanelGUI.show({
    {text = "Kick Spieler", callback = function() outputChatBox("Kick!") end},
    {text = "Ban Spieler", callback = function() outputChatBox("Ban!") end},
})
]]

function AdminPanelGUI.show(actions)
    UniversalGUI.create{
        title = "Adminpanel",
        logo = "images/admin_icon.png",
        labels = {
            {text = "Admin-Aktionen:", color = {255,255,255}},
        },
        buttons = actions,
        onClose = function() outputChatBox("Adminpanel geschlossen!") end
    }
end
